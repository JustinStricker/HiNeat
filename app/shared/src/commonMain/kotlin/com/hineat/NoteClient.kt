...
import com.hineat.auth.ToggleTaskRequest
import com.hineat.core.BaseClient
import com.hineat.core.PaginatedResponse
import com.hineat.core.PublicPostResponse
import com.hineat.core.PublicPostsResponse
import com.hineat.core.SyncNotesResponse
import com.hineat.core.getServerUrl
...
class NoteClient(httpClient: HttpClient, serverUrl: String = getServerUrl()) : BaseClient(httpClient, serverUrl) {
    ...
    suspend fun syncNotes(limit: Int, offset: Int): PaginatedResponse<Note> {
        val response: com.hineat.core.SyncNotesResponse = httpClient.get("$serverUrl/sync/notes") {
            auth()
