...
import com.hineat.core.SyncTasksResponse
import io.ktor.client.call.*
import io.ktor.client.request.*
import io.ktor.http.*

class TaskClient(httpClient: io.ktor.client.HttpClient, serverUrl: String = com.hineat.core.getServerUrl()) : BaseClient(httpClient, serverUrl) {
