...
import com.hineat.core.AppDrawer
import com.hineat.core.AppTheme
import com.hineat.core.ExplorePostDetailScreen
import com.hineat.core.ExploreScreen
import com.hineat.core.ExploreViewModel
import com.hineat.core.SettingsScreen
import com.hineat.local.createAppDatabase
import com.hineat.notes.NoteEditorScreen
import com.hineat.notes.NotesListScreen
import com.hineat.notes.NotesViewModel
import com.hineat.notes.RoomNotesRepository
import com.hineat.notes.SyncingNotesRepository
import com.hineat.sync.SyncViewModel
import com.hineat.tasks.RoomTasksRepository
import com.hineat.tasks.SyncingTasksRepository
import com.hineat.tasks.TasksScreen
import com.hineat.tasks.TasksViewModel
...
fun App() {
    ...
    val taskClient = remember { com.hineat.tasks.TaskClient(httpClient) }
    ...
    val savedToken = remember { com.hineat.core.AppSettings.authToken }
    remember(savedToken) {
        if (savedToken != null) {
                        ...
                        actions = {
                            when {
                                currentDestination?.hasRoute<Screen.NotesList>() == true -> {
                                    ...
                                    if (isLoggedIn) {
                                        if (notesSyncState == com.hineat.notes.SyncState.SYNCING) {
                                ...
                                currentDestination?.hasRoute<Screen.TasksList>() == true -> {
                                    ...
                                    if (isLoggedIn) {
                                        if (tasksSyncState == com.hineat.notes.SyncState.SYNCING) {
                                            CircularProgressIndicator(modifier = Modifier.size(14.dp), strokeWidth = 2.dp)
                                        } else {
